    ...
    public class ItemController : Controller
    {
        ...
        public IActionResult Index()
        {
            var model = _context.Items
                                .Where(x => x.User.Id == _userManager.GetUserAsync(HttpContext.User).Result.Id)
                                .ToList();
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (item != null && !item.User.Id.Equals(_userManager.GetUserAsync(HttpContext.User).Result.Id))
            {
                return Unauthorized();
            }
